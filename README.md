...
一个本地优先的中文 RAG（检索增强生成）知识库问答系统：上传文档自动建库，提问时先在本地向量库检索相关片段，再交给 DeepSeek 大模型基于片段生成**可溯源**的回答，并对**无关问题阈值拒答**以降低幻觉。

样例资料是一份《院系教学信息管理系统》毕业论文，但系统是通用的——可替换为课程资料、规章制度、产品手册、企业知识库等任意中文文档。
